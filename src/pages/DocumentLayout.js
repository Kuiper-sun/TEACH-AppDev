...
const DocumentLayout = () => {
    ...
    const handleDocumentClick = (docTitle) => {
        // Navigate to the Lesson Plan page or other document-based page.
        if (docTitle === "Lesson Plan") {
            navigate('/lesson-plan');
        }
        // Add other conditions for other document titles if needed.
    };

    const documents = [
        { title: "Lesson Plan", id: 1, description: "Create and manage your lesson plans" },
        { title: "Daily Lesson Log", id: 2, description: "Track daily teaching activities" },
        { title: "Daily Time Record", id: 3, description: "Record and monitor teaching hours" }
    ];
        ...
        <div className="flex h-screen bg-blue-400">
            ...
            <div className="flex-1 bg-white rounded-tl-3xl p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {documents.map(doc => (
                        <div key={doc.id} className="p-4 rounded-lg border hover:shadow-lg transition-shadow">
                            <div className="w-full h-40 bg-gradient-to-br from-teal-400 via-blue-400 to-blue-500 rounded-lg mb-4" />
